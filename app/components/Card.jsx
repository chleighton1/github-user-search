    ...
    <div className="bg-card-light dark:bg-card-dark shadow-lg px-5 py-3 rounded-xl">
      <div className="flex justify-start gap-5 items-center mb-6 mt-6">
        ...
        <div>
          ...
          <h3>{`Joined ${userData.joined.toLocaleString(
            DateTime.DATE_MED
          )}`}</h3>
        </div>
      </div>
      ...
      <div className="grid dark:text-white grid-flow-row grid-cols-contact gap-2 grid-rows-4 mb-6">
        <svg
          height="20"
          width="14"
          className={userData.location ? "fill-current" : "fill-na"}
        ...
        <p className={userData.location ? "" : "text-na"}>
        ...
        <svg
          height="20"
          width="20"
          className={userData.blog ? "fill-current" : "fill-na"}
          xmlns="http://www.w3.org/2000/svg"
        >
          <g>
        ...
        <svg
          height="18"
          width="20"
          className={userData.twitter ? "fill-current" : "fill-na"}
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <p className={userData.twitter ? "" : "text-na"}>
        ...
        <svg
          height="20"
          width="20"
          className={userData.company ? "fill-current" : "fill-na"}
          xmlns="http://www.w3.org/2000/svg"
        >
          <g>
        ...
        <p className={userData.company ? "" : "text-na"}>
